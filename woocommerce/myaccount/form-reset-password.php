...
<div class="col-md-6 waiting-approve-messages">
	<div class="telefire-auth-form">
		<div class="head-form" style="margin-bottom: 15px;">
			<h2><?php echo apply_filters( 'woocommerce_reset_password_message', esc_html__( 'Enter a new password below.', 'woocommerce' ) ); ?></h2>	
		</div>

		<form method="post" class="woocommerce-ResetPassword lost_reset_password">

			<p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-wide" style="position: relative;">
			...
			<p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-wide" style="position: relative;">
				<i class="fa fa-eye toggle-password" aria-hidden="true"></i>
			...
			<p class="woocommerce-form-row form-row" style="display: block;">
				<input type="hidden" name="wc_reset_password" value="true" />
				<button type="submit" class="woocommerce-Button button btn-telefire" value="<?php esc_attr_e( 'Save', 'woocommerce' ); ?>"><?php esc_html_e( 'Save', 'woocommerce' ); ?></button>
			</p>
