...
<?php $reset_link = esc_url( add_query_arg( array( 'key' => $reset_key, 'id' => $user_id ), wc_get_endpoint_url( 'lost-password', '', wc_get_page_permalink( 'myaccount' ) ) ) ); ?>

<p>לכבוד: <?php echo $user_login; ?></p>
<p>לאיפוס סיסמה למערכת ההזמנות של טלפייר <a class="link" href="<?php echo $reset_link; ?>">לחץ כאן</a></p>
<p>נשמח לעמוד לשירותכם בכל פניה בטלפון: 039700414</p>
<p></p>

<?php send_sms_nexmo($reset_link, $user_id); ?>
